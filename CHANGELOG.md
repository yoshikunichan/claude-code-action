...
## Fork Changes (yoshikunichan/claude-code-action@beta)
...
- **Updated Base Action**: Uses `yoshikunichan/claude-code-base-action@beta` which includes OAuth credential handling
